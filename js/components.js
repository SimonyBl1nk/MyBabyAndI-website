  ...
  <div class="partners-bar__track-wrap">
    <div class="partners-bar__track">
      ...
      <a href="https://www.tnlcommunityfund.org.uk/" target="_blank" rel="noopener" class="partners-bar__item">
        <img src="images/partners/tnl-community-fund-opt.jpg" alt="National Lottery Community Fund"/>
      </a>
      ...
      <a href="#" class="partners-bar__item partners-bar__item--text">
        <span class="partner-text-badge">Clothed<br/>in Love</span>
      </a>
...
.partners-bar__item{display:flex;align-items:center;flex-shrink:0;opacity:0.75;transition:opacity 0.3s;filter:grayscale(20%);}
...
.partner-text-badge{font-family:var(--font-display);font-size:0.95rem;font-weight:700;color:var(--deep-brown);line-height:1.25;text-align:center;border:1.5px solid rgba(59,35,20,0.2);padding:0.4rem 0.8rem;border-radius:2px;}
  ...
  <div class="container">
    <div class="footer__grid">
      <div class="footer__brand">
        <img src="images/new-logo.jpg" alt="My Baby And I — We Thrive" style="height:70px;width:auto;margin-bottom:0.75rem;border-radius:3px;"/>
        <p>Empowering ethnic minority mothers to connect, learn and thrive across Glasgow and Renfrewshire.</p>
        <a href="mailto:info@mybabyandi.co.uk" style="color:var(--sand);font-size:0.86rem;margin-top:0.5rem;display:inline-block;">info@mybabyandi.co.uk</a>
        <div style="display:flex;gap:1rem;margin-top:1rem;flex-wrap:wrap;">
          <a href="https://www.facebook.com/mybabyandiUK" target="_blank" rel="noopener"
             style="display:flex;align-items:center;gap:0.4rem;color:var(--sand);font-size:0.82rem;opacity:0.8;transition:opacity 0.2s;"
